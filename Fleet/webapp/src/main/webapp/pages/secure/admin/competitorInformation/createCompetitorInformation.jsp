...
<s:form name="baseForm" id="baseForm" method="POST" >
	<div class="policyRegn_section_div" style="width:99%;">
		<div class="admin_section_heading">
	    	<s:text name="label.manageCompetitorInfo.createNewCompetitorInfo"/>
	 	</div>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="grid">
        	...
        	<tr>
	            ...
	            <td  height="19" class="labelNormal" align="left" >
	                <sd:autocompleter  href='list_ItemGroups.action' name='competitorBrandModel.equiNmhgModel' value='%{competitorBrandModel.equiNmhgModel.groupCode}' loadOnTextChange='true' loadMinimumCount='3' keyName="competitorBrandModel.equiNmhgModel" key="%{competitorBrandModel.equiNmhgModel.id}" keyValue="%{competitorBrandModel.equiNmhgModel.id}" showDownArrow='false' indicator='indicator' />
	...
	<div align="center" style="margin:10px 0; width:58%;"><s:submit
			...
			</script> <s:submit value="Save" cssClass="buttonGeneric"
			action="save_Competitor_Information" />
	</div>
</s:form>
