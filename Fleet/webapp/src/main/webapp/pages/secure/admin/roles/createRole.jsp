				  ...
				  <s:set name="subjectAreaId" value="%{subjectArea.id}" />		
					<s:iterator value="functionalAreas" status="iter1" >
						<tr width="100%">
						    ...
						    <td width="19%" valign="middle" align="center" class="labelBold" rowspan="<s:property value="functionalAreas.size()" />">
						       <s:property value="subjectAreas[#iter.index].subjectArea.name" />
						       	<s:hidden name="subjectAreas[%{#iter.index}].subjectArea"
								value="%{#subjectAreaId}" />
						     </td>
						    </s:if>
							<td width="19%" class="labelBold"><s:property value="%{functionalArea.name}" />
							   <s:hidden name="subjectAreas[%{#iter.index}].functionalAreas[%{#iter1.index}].functionalArea"
								value="%{functionalArea.id}" />
							</td>
							<td class="labelNormal" width="34%">
