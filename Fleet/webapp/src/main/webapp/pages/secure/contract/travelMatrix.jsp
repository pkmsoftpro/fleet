    ...
    <div class="containerDiv"
        ...
        <table border="1" cellspacing="0" cellpadding="0" class="accordion-table">
            ...
            <tr class="tableData" ng-repeat="item in contract.activeContractAudit.applicableTravelMatrix">
                ...
                <td><input style="margin-bottom: 2px; margin-top: 2px; width: 100px" type="text" class="repeat" data-ng-model='item.milesPerTrip'></input>
                </td>
                <td>
                    <div class="cellDiv" style="width: 226px;"
                        data-ng-init="item.travelFlatAmount.currency = item.travelFlatAmount.currency == null ? contract.activeContractAudit.forCustomer.preferredCurrency : item.travelFlatAmount.currency">
