...
<table  cellspacing="0" cellpadding="0" id="claim_details_table" width="100%" class="grid borderForTable" style="clear: both;margin:0px;">
    <thead>    
        <tr>        
            ...
            <th class="warColHeader" width="5%" class="non_editable"><s:text name="label.common.fleetClaimNumber"/></th>
            ...
            <th class="warColHeader" width="5%"><s:text name="label.common.workOrderNumber"/></th>
