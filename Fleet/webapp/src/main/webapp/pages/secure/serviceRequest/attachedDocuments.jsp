<div
    data-ng-init="serviceRequest.activeServiceRequestAudit.attachments = serviceRequest.activeServiceRequestAudit.attachments == null ? [] : serviceRequest.activeServiceRequestAudit.attachments"
    data-ng-model="serviceRequest.activeServiceRequestAudit.attachments">
