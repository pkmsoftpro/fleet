...
<html>
<head>
<title><s:text name="title.serviceRequest.location_wiseServiceRequest" /></title>
<s:head theme="twms" />
...
<script type="text/javascript">
        ...
        function exportToExcel() {
        	exportExcel("/serviceRequest/populateCriteria","exportLocationWiseRDataToExcel.action");
        }
    </script>
...
<u:body>
        <div dojoType="dijit.layout.LayoutContainer" class="wid-100p hgt-100p">
            ...
            <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="serviceRequestTable"
                bodyUrl="locationWiseServiceRequestBody.action?" folderName="${folderName}" detailUrl="serviceDetail.action" parentSplitContainerId=""
