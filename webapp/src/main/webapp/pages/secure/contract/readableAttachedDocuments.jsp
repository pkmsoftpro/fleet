        ...
        <tr class="tableData" data-ng-repeat="document in contract.activeContractAudit.attachments">
            ...
            <td>
                <div class="floatL marL110">
                    <select data-ng-model="document.documentType.id" ng-options="docType.id as docType.name for docType in docTypes" ng-style="{width:'80px'}" class="dropdown-normal" data-ng-disabled="true">
