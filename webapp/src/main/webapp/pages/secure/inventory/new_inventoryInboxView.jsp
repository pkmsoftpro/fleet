...
<html>
<head>
<title><s:text name="title.inventory.inboxView" /></title>
<s:head theme="twms" />
...
<script type="text/javascript">
       ...
       function exportToExcel(){
        	exportExcel("/inventory/populateCriteria","exportInventoriesToExcel.action");
        	} 
       ...
       function handleShowSearch(event, dataId) {
           ...
           formObj.action = "showPreDefinedInventorySearchQuery.action";
           formObj.submit(); 
 		}
    </script>
...
<u:body>
    <s:hidden name="inventorySearchCriteria" value="inventorySearchCriteria" />
    <s:set name="inventorySearchCriteria" value="inventorySearchCriteria" />
    <div dojoType="dijit.layout.LayoutContainer" class="wid-100p hgt-100p">
        <div dojoType="dijit.layout.ContentPane" layoutAlign="top" class="buttonContainer">
            ...
            <u:summaryTableButton id="refreshButton" label="button.common.refresh" onclick="refreshIt" align="right" cssClass="refresh_button"
                summaryTableId="inventorySearchTable" />
            <u:summaryTableButton id="downloadListing" label="button.common.downloadToExcel" onclick="exportToExcel" align="right"
                cssClass="download_to_excel_button" summaryTableId="inventorySearchTable" />
            <u:summaryTableButton id="searchButton" label="button.view.showSearchQuery" onclick="handleShowSearch" summaryTableId="inventorySearchTable"
        ...
        <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="inventorySearchTable"
            bodyUrl="preDefinedInventorySearchSummaryBody.action" extraParamsVar="extraParams" folderName="Inventory Search"
            detailUrl="equipmentDetailsInfo.action" parentSplitContainerId="" populateCriteriaDataOn="/inventory/populateCriteria">
