...
<script type="text/javascript">
    function changeInboxView() {
        ...
        if (domainPredicateName)
            ...
            tabName = document.getElementById("folder").value;
...
<input type="hidden" id="defaultHeaderSize" value='${defaultHeaderSize}'>
<input type="hidden" id="folderName" value='${folderName}'>
<input type="hidden" id="inboxViewSortField" value='${inboxViewSortField}'>
<input type="hidden" id="inboxViewSortOrder" value='${inboxViewSortOrder}'>

<script>
    function inboxViewActions() {
    ...
    function createView() {
        ...
        var url = "../inboxViewAction.action?context=" + document.getElementById("context").value + "&parentFrameId=" + encodedSelfName + "&folderName="
                + document.getElementById("folder").value + "&defaultHeaderSize=" + document.getElementById("defaultHeaderSize").value;
    ...
    function editView() {
        ...
        var url = "../inboxViewAction.action?context=" + document.getElementById("context").value + "&parentFrameId=" + encodedSelfName + "&id="
                + selectedInboxViewId + "&folderName=" + document.getElementById("folder").value + "&defaultHeaderSize="
...
<form:form commandName="stb">
<table border="0" cellspacing="0" cellpadding="0" width="15%" align="right">
    <tr>
        <td align="right" style="padding-top: 7px"><select name="inboxViewAction" id="inboxViewAction" onchange="inboxViewActions()">
                <options>
                <option value="0">
    ...
    <form:select path="inboxViewId" name="inboxViewId"
                    id="inboxViewsList" onchange="javascript:changeInboxView()">
                    <form:option label="Default View" value="-1" />
                    <form:options items="${inboxViews}" itemLabel="name" itemValue="id" />
                </form:select>
            </td>
    </tr>
</table>
