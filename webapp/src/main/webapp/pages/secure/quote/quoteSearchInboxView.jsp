...
<html>
<head>
<title><s:text name="title.managePolicy.quoteSearchInboxView" /></title>
<s:head theme="twms" />
...
<script type="text/javascript">
        function exportToExcel(){
            exportExcel("/quoteSearch/populateCriteria","exportQuoteSearchToExcel.action");
           }
        function refreshIt() {
            publishEvent(SUMMARY_TABLE_UTIL.getRefreshFullTopic("quoteSearchConfigTable"));
        }
		...
		function getPageUrl() {
	    	return '../dynamicQuoteSearchResult.action?domainPredicateId=<s:property value="domainPredicateId"/>&'+
...
<u:body>
    <div dojoType="dijit.layout.LayoutContainer" style="width: 100%; height: 100%">
        ...
        <u:summaryTableButton id="refreshButton" label="button.common.refresh" onclick="refreshIt" align="right" cssClass="refresh_button" summaryTableId="quoteSearchConfigTable"/>
         <u:summaryTableButton id="downloadListing" label="button.common.downloadToExcel" onclick="exportToExcel"
               align="right" cssClass="download_to_excel_button" summaryTableId="quoteSearchConfigTable"/>
               <u:summaryTableButton id="searchButton" label="button.view.showSearchQuery" onclick="handleShowSearch" summaryTableId="quoteSearchConfigTable"cssClass="show_search_query_button" />  
        ...
        <s:hidden id="folderName" value="Quotes Search" />
        <div dojoType="dijit.layout.SplitContainer" layoutAlign="client" orientation="vertical" sizerWidth="4" activeSizing="false" id="split" persist="false">
            ...
            <u:summaryTable eventHandlerClass="tavant.twms.summaryTable.BasicTwmsEventHandler" id="quoteSearchConfigTable"
                bodyUrl="quoteSearchBody.action" extraParamsVar="extraParams" folderName="Quotes Search" detailUrl="ServiceRequestQuoteDetail.action"
                parentSplitContainerId="" populateCriteriaDataOn="/quoteSearch/populateCriteria">
